...
public class HttpHelper {
    ...
    public final int TIMEOUT_MILLIS = 50000;
    public boolean LOG_ON = false;
    private String contentType;
    private String charsetToEncode;

    public String doGet(String url, Map<String, String> parametros) throws IOException {
        return doGet( url, null, "UTF-8", null );
    }

    public String doGetApi(String url, Map<String, String> parametros, String token) throws IOException {
        return doGet( url, null, "UTF-8", token );
    }

    public String doGet(String url, Map<String, String> params, String charset, String token) throws IOException {
